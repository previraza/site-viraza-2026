...
date: 2025-03-13
title: 'Zen'
image: '/images/blog-images/covers/zen.jpg'
...
- Most importantly, we needed logging middleware that could run _after_ error handling was complete, to capture the final HTTP status code and response body that was actually sent to the client
        ...
        return func(ctx context.Context, s *Session) error {
            ...
            case fault.NOT_FOUND:
                return s.JSON(http.StatusNotFound, api.NotFoundError{
                    Title:     "Not Found",
                    Type:      "https://viraza.net/docs/errors/not_found",
            ...
            case fault.BAD_REQUEST:
                return s.JSON(http.StatusBadRequest, api.BadRequestError{
                    Title:     "Bad Request",
                    Type:      "https://viraza.net/docs/errors/bad_request",
                    Detail:    fault.UserFacingMessage(err),
                    RequestId: s.requestID,
            ...
            return s.JSON(http.StatusInternalServerError, api.InternalServerError{
                ...
                Type:      "https://viraza.net/docs/errors/internal_server_error",
                Detail:    fault.UserFacingMessage(err),
                RequestId: s.requestID,
...
Zen lives in our open source mono repo, so you can explore or even use it in your own projects. The full source code is available in our GitHub repository at [github.com/virazait/tree/main/go/pkg/zen](https://github.com/virazait/tree/main/go/pkg/zen).
