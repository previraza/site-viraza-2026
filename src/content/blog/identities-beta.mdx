...
image: '/images/blog-images/covers/identities-beta.jpg'
description: 'Manage multiple keys under one user or organisation, with shared ratelimits and analytics.'
author: andreas
tags: ['product']
---

<Image src="/images/blog-images/covers/identities-beta.jpg" />
...
If your identity is configured with metadata and/or ratelimits, you can now [verify a key](https://viraza.net/docs/api-reference/v2/keys/verify-api-key).
