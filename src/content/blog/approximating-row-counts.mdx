...
image: '/images/blog-images/covers/approximating-row-counts.jpg'
description: 'Caching count(*) queries without a cache'
author: andreas
tags: ['engineering']
---

Viraza allows users to create an unlimited number of API keys for their applications. Counting these for our dashboard or API has become a growing issue for us.
...
2. Caching the `count(*)` query separately in our [tiered cache](https://viraza.net/blog/announcing-unkey-cache-package) using SWR semantics.
