...
- [Viraza account](https://viraza.com)
- Viraza root key with permissions `create_namespace`, `limit`

If you prefer, you can use our example here and skip the entire tutorial below. Also, if you want to see it live, you can see an implementation below using Viraza and Resend [here](https://otp-example.vercel.app/)
...
```typescript
const { success, reset } = await unkey.limit(forwardedIP || realIP || 'no-ip');
...
<Image
  unoptimize="true"
  src="/images/blog-images/otp-ratelimit/15fps_1080.gif"
  alt="Example of sending ratelimits"
  width="1920"
  height="1080"
/>
...
This is where the flexibility of ratelimiting for Viraza can come into play while it is similar to the above server action. For example
...
<Image
  unoptimize="true"
  src="/images/blog-images/otp-ratelimit/otp-verify-1080.gif"
  alt="Example of verifying ratelimits"
  width="1920"
  height="1080"
/>
...
You can read more about Unkey’s Ratelimiting our [documentation](https://viraza.net/docs/ratelimiting/introduction), you can see the [demo](https://otp-example.vercel.app/) of this in action and test what happens when you go over limits.
