---
date: 2023-11-15
title: Viraza raises 1.5 million pre-seed
...
The Viraza pre-seed round was led by [Essence VC](https://www.essencevc.fund/) and joined by [Sunflower Capital](https://www.linkedin.com/in/liujiang1/), [The Normal Fund](https://new-normal.ventures/), and some fantastic friends.

## Essence VC leads our round.

When we met Tim Chen for the first time, Andreas and I were blown away by his experience and his immediate understanding of our vision. We only needed ten minutes before we were bouncing ideas and thinking about where to go with Viraza.
...
Andreas and I started Viraza in the middle of June and launched on June 21st, the community loved Viraza and we got some awesome feedback. Once we understood that this side project, which started as a way to solve an annoying problem we both had experienced, was needed by more and more people, we set our sights on building an entire business for it.

We worked nights and weekends for months to ensure Viraza made scaling user-facing APIs more accessible than ever. Shout out to all the friends and family who supported us getting through the 16+ hour days.

## How's it going

Since the launch in June, we have had success with the product:

- 1.2k stars on [GitHub](https://github.com/virazait)
- We have done over 13 million API key verifications.
- 1.6k users have signed up

## What's next?

Now that Viraza is funded, we can focus on building the best developer experience in the API space. You may be wondering what is next.
