...
image: '/images/blog-images/covers/uuid-ux.jpg'
...
<div className="text-center">TLDR: Please don't do this:</div>
```bash https://company.com/resource/c6b10dd3-1dcf-416c-8ed8-ae561807fcaf ```
