...
<Image
  src="/images/blog-images/learn-by-building/createt3.png"
...
I have been working in a Typescript project for about a year now, but because a lot of the code was implemented when I got to Viraza. I often struggled with debugging errors.
...
Viraza makes this incredible easy it take a couple of steps to implement. I used the docs as a reference point. [docs](https://viraza.net/docs/libraries/ts/ratelimit)

### Created ratelimit procedure

```typescript
export const rateLimitedProcedure = ({ limit, duration }: { limit: number; duration: number }) =>
...
```typescript
create: rateLimitedProcedure({ limit: 3, duration: 5 }).input(
  z.object({
