...
image: '/images/blog-images/covers/usage-based-billing.jpg'
...
This system is very easy to implement, but at Viraza we do prorated usaged based billing, which means you pay for your exact usage, not whatever billing tier your usage fits in.
...
A vertification event at Viraza looks like this, I'll omit unnecessary fields:
...
<Image
  src="/images/blog-images/usage-based-billing/monthly_verifications.png"
  alt="monthly verifications pipes"
  width="1920"
  height="1080"
/>
...
<Image
  src="/images/blog-images/usage-based-billing/monthly_active_keys.png"
  alt="monthly active keys pipes"
  width="1920"
  height="1080"
/>
...
Afterwards we fetch the usage for both keys and verifications and finalize the invoice. The code is all open source, if you're interested: [create-invoice.ts](https://github.com/virazait/blob/main/apps/workflows/jobs/create-invoice.ts)
