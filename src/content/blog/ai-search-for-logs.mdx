...
image: '/images/blog-images/covers/ai-search.jpg'
...
This pattern allows for incredible flexibility - you can chain multiple conditions while maintaining readability. To handle these parameters in our Viraza dashboard, we implemented a custom parser for [nuqs]("https://nuqs.47ng.com/"):
