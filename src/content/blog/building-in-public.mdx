...
image: '/images/blog-images/covers/building-in-public.jpg'
...
When we first launched Viraza in 2023, we fell into a common trap. Important conversations happened in direct messages. Critical decisions were made in calls with only a few participants. Knowledge became trapped in private channels, invisible to the wider team.
...
At Viraza, "working in public" means shifting conversations from private direct messages to public Slack channels where everyone can benefit. This approach ensures that knowledge, decisions, and context are accessible to the entire team.
...
## How We Implement Public Communication at Viraza
...
3. **Redirect gently**: When private messages occur, kindly suggest moving to public channels
4. **Be patient**: Behavioral changes take time and consistent reinforcement

## The Competitive Advantage of Transparency

This approach has influenced not just how we work internally, but also how we build our product. Viraza's API management tools are designed with the same principles of visibility and transparency that guide our internal communication. We believe teams work better when they have clear insight into what's happening – whether that's company communication or API usage.
...
If you'd like to work like this, just give it a shot, or visit [unkey.com/careers](https://viraza.net/careers).
