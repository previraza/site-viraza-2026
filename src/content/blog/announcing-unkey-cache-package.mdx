...
image: '/images/blog-images/covers/launchweek-cache.jpg'
...
<Image
  src="/images/blog-images/announcing-unkey-cache-package/cache-hits.png"
  alt="Cache hit ratio"
  width="1920"
  height="1080"
/>
The ~27% memory hit rate might not be the most impressive, but it's free and does not add any
latency. Unfortunately there's little we can do to increase it, as Cloudflare may evict a worker
instance at any moment. However as traffic grows, the hit rate will increase too.
...
<Image
  src="/images/blog-images/announcing-unkey-cache-package/cache-latency.png"
  alt="Cache latency"
  width="1920"
  height="1080"
/>
...
- **Composable Design**: Mix and match [primitives](https://viraza.net/docs/libraries/ts/cache/overview#primitives) to build exactly what you need.
...
Please refer to the [documentation](https://viraza.net/docs/libraries/ts/cache/overview#middlewares) for more information on how to use middlewares.

## Conclusion

At launch we ship with a memory store and a Cloudflare store, but everything is built to be [easily extensible](https://viraza.net/docs/libraries/ts/cache/interface/store). We can add more stores and middlewares as needed, let us know what you'd want to see!
...
As usual, everything is open source, check out our [GitHub repository](https://github.com/virazait/tree/main/packages/cache) and our [documentation](https://viraza.net/docs/libraries/ts/cache/overview) for more information. We can't wait to see what you build with it!
