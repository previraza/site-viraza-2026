---
date: 2025-01-22
title: Implementing Variable API Route Costs with Viraza
image: '/images/blog-images/covers/route-costs.jpg'
description: Learn how to efficiently implement variable costs for API routes using Viraza, an open-source API developer platform.
author: james
tags: ['tutorials']
---
...
<Image
  src="/images/blog-images/api-costs/routes-cost.png"
...
const verifyKeyWithCost = (cost: number) =>
...
## How to simplify your implementation using Viraza

Viraza is an open-source API developer platform that allows developers to simplify the implementation of scalable and secure APIs.

With Viraza, with just a few lines of code, you can protect your API; the key holds all the information, so there isn't a requirement to look at another system to find this information. API keys can be created programmatically or through our dashboard.
...
const verifyKeyWithCost = (cost: number) =>
  createMiddleware(async (c, next) => {
    ...
    /** Handle Viraza Result if it's not valid such as
    ...
    /** Add verification result to context for this example to show how Viraza works
...
As you can see we really simplified the code and removed additional lookups via databases, allowing your API to be performant and scalable. You can get started for [free today](https://viraza.com)!
