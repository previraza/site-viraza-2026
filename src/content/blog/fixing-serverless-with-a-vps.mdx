...
- **Message size**: Maximum of 2056 characters per log line _(That's not really that much data if you encode it in JSON)_
- **Array limit**: 20 elements _(I still don't know what this refers to)_
...
See the [readme](https://github.com/virazait/tree/main/apps/agent#config) for all available options.
