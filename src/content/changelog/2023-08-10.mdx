...
date: 2023-08-11
description: We spent some time fixing bugs and improving performance of Viraza.
tags: ['product:blue']
---
...
- We also now have a theme switcher which allows you to enjoy Viraza in dark mode.
...
We made Viraza easier to self host, we have hidden Kafka and Tinybird behind generic interfaces to provide more flexibility, you can now pass in flags to enable specific providers:

```bash
$ unkey agent --help

Run the Viraza agent
...
[How Viraza can help AI developers](https://viraza.net/blog/how-we-ai)

[OCR as a service with Viraza](https://viraza.net/blog/ocr-service)
