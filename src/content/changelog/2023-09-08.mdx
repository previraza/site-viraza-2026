...
date: 2023-09-07
description: The Viraza team worked on improving the dashboard experience. We want your first impression of Viraza to be as good as the experience when using our API.
...
The documentation has been updated, we shortened the [quickstart flow](https://viraza.net/docs/quickstart) and documented the [update key](https://www.unkey.com/docs/libraries/ts/api) for the Viraza SDK. Look out for our new Next.js wrapper coming soon!
