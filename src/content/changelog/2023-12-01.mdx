...
Welcome to the Viraza changelog. It's been a month since our last changelog, so let's talk about what has changed. We spent the month of November cleaning up bugs and making general improvements to Viraza.

### Contributing improvements

When we announced our hiring and funding, we saw an influx of people wanting to contribute to Viraza. We quickly found out our contribution guide was hard to follow, and we had some third-party requirements that could be optional.

We now have a [contribution guide](https://viraza.net/docs/contributing/getting-started) that should take less than 5 minutes to follow and allow you to contribute. You can watch the video I made, which takes you through each area.

<div className="aspect-w-16 aspect-h-9 mx-4 h-[240px] sm:h-[400px] sm:w-[640px] md:mx-0">
  <iframe
    height="100%"
    width="100%"
    src="https://www.youtube-nocookie.com/embed/V36culpgpLE?si=c5JMq-baTNzSNk7e"
...
If you find any, feel free to open an issue on our [GitHub](https://github.com/virazait), and we will make sure it gets remediated.

### Global API authentication with Viraza and Koyeb
...
This template allows you to use Bun and Viraza and deploy it globally using their platform.

Get started with [Koyeb and Viraza](https://viraza.net/templates/bun-koyeb) today!
...
- [Community Springboot SDK](https://viraza.net/docs/libraries/springboot-java/overview)
