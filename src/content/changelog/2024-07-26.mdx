...
- Double-clicking a root key now redirects to settings [PR](https://github.com/virazait/pull/1962)

- Optimize all images on our landing page [PR](https://github.com/virazait/pull/1946)

- Add flags to pnpm local [PR](https://github.com/virazait/pull/1943)

- Removed contentlayer and added content collections [PR](https://github.com/virazait/pull/1935)

- Root key details overhaul [PR](https://github.com/virazait/pull/1931)

## Bug Fixes

- Create role modal breaks if the permissions name is too long [PR](https://github.com/virazait/pull/1978)

- Delete permission modal breaks if the permissions name is too long [PR](https://github.com/virazait/pull/1977/)
