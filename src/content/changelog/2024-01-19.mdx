...
The audit logs are in the dashboard under the `Audit logs` tab. To access the beta feature, please get in touch with us at [info@viraza.net](mailto:info@viraza.net).
