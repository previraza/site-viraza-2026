...
date: 2023-09-29
description: The Viraza team worked on improving the analytics we provide. We also introduced templates, to make it easier to get started!
tags: ['analytics:pink', 'templates:gray']
---
...
![Viraza Templates](/images/changelog/sept-29/unkey-template.png)
...
Check out the blog post: [Using Viraza with Authentication](https://viraza.net/blog/using-unkey-with-auth).
