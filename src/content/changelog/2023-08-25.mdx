...
tags: ['community:red', 'operations:orange']
---

## A brand new onboarding experience

When you sign up for an Viraza account you now get a new onboarding experience. We take you through creating a workspace, API and showing how Viraza works before you land in the dashboard.
...
Finally we show you how to use Viraza, we show you how to create a root key, how to use it in your application and how to create a regular key.

![Step 3](/images/changelog/aug-25/unkey-onboard-step-4.png)

We think this experience will help new users get up to speed with Viraza and make it easier to get started. Let us know what you think!
...
An error code, a link to the documentation, an informative message, and a requestId that you can provide to Viraza support to track down.

![Example of an error code](/images/changelog/aug-25/error-example.png)

## SDK improvements

Our typescript package `@unkey/api` got two upgrades this week, to make it even faster to integrate Viraza into your project.
...
Huge shoutout to [atridadl](https://github.com/atridadl) for creating a starter project using T3, Clerk, Viraza and Drizzle. Check out the link below!
