...
<Picture
  src="/images/changelog/2025-02-07/logs.png"
  alt="Logs example"
  width="1920"
  height="1080"
/>
...
<Picture
  src="/images/changelog/2025-02-07/ratelimit.png"
  alt="Rate limit logs example"
  width="1920"
  height="1080"
/>
...
**Permanent Key Deletion**: You can now permanently delete a key. By default, Viraza has the ability to recover a key if requested, but by passing `"permanent": true` with your deletion request, you can bypass this recovery option.
...
- [**Don't Retry on 4XXs**](https://github.com/virazait/pull/2862) - We stopped our TS SDK from retrying if a 4XX is returned from our API.
- [**pnpm Local Command to Exit if DB Migration Fails**](https://github.com/virazait/pull/2857) - We now handle cases where one of our migrations fails when spinning up our local environment; prior to this, it would hang with zero user indication.
- [**Remove Transaction Deadlock from Dashboard**](https://github.com/virazait/pull/2843) - We fixed an issue where, in the Viraza dashboard, our DB would be deadlocked, causing errors when operations were attempted.
