...
After [Accelerate](https://viraza.net/accelerate) our first-ever launch week, where we launched products like Toolbox, vault, and LLM caching. We are now working on improving infrastructure, usability, and our docs.
...
- Fix UI Caching issue when deleting keys [Link to PR](https://github.com/virazait/pull/1840)

- Add missing permissions to root keys in the dashboard [Link to PR](https://github.com/virazait/pull/1879)

- Filter out deleted keys from permissions[Link to PR](https://github.com/virazait/pull/1883/)
