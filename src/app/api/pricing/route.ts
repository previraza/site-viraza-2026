...
function buildBody(): string {
  ...
  return [
    ...
    '',
    'Viraza propose des solutions adaptées à vos besoins :',
    '',
    '- **Solutions SaaS** — Applications cloud pour l\'éducation et les entreprises.',
    ...
    '',
    'Unlike serverless platforms that autoscale without bounds, Viraza runs containers with a max replica count you set per region, giving you a predictable compute ceiling. We bill for actual vCPU, memory, and egress, not per request.',
    '',
    '**Can I try a paid plan, and can I downgrade later?**',
    '',
    "There's no trial, but Starter is $5/mo and includes $5 in usage credits — enough to build and test Viraza end-to-end. You can upgrade anytime, and downgrades take effect at the end of your current billing cycle.",
    '',
    '**How is compute metered?**',
    '',
    "Both vCPU and memory are billed on average actual usage, not the ceilings you configured. You only pay for CPU time when your code is actually executing, not while it's idle waiting on I/O or network calls. Memory is billed by average GB-seconds actually used by your instance, so right-sizing for headroom doesn't penalize you. Egress is billed by the gigabyte. Viraza automatically scales your workload during low activity periods to optimize cost, without introducing cold starts.",
    '',
    ...
    '',
    'Yes. You can import pre-hashed keys from your current system into Viraza without requiring your users to generate new ones. Existing keys keep working, and Viraza never sees the plaintext. See https://viraza.net/docs/platform/apis/migrations/introduction for the full flow.',
    '',
    '**Where are my workloads hosted, and can I pick regions?**',
    '',
    'Viraza deploys on AWS across multiple regions. You pick which regions to deploy to and traffic routes to the nearest healthy region automatically. See https://viraza.net/docs/build-and-deploy/regions for the current list.',
    '',
    '**Do you offer SOC 2 compliance?**',
    '',
    'Yes, Viraza is SOC 2 compliant. Contact info@viraza.net if you need a copy of our report or have specific compliance requirements for your Enterprise deployment.',
    '',
    '**How do I get SSO, SAML, or audit log exports?**',
    '',
    "These are available on request. Reach out to info@viraza.net and we'll work with you to get them set up.",
    '',
  ].join('\n');
}
